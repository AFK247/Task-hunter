    ...
    <div style={{ width: "200px" }} className=" ms-3 side-nav-open">
      <div className="flex-column pt-2 nav">
        <div className="nav-item ">
          <Link to="/dashboard" className="side-bar-item mt-2 d-flex">
            <RxDashboard />
            <a className="side-bar-item-caption ms-2 mb-1 text-decoration-none">
              Dashboard
            </a>
          </Link>
        </div>
        <div className="nav-item">
          <Link to="/dashboard/allTask" className="side-bar-item mt-2 d-flex">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
        ...
        <div className="nav-item">
          <Link
            ...
            className="side-bar-item mt-2 d-flex"
          >
            <svg
              stroke="currentColor"
              fill="currentColor"
        ...
        <div className="nav-item">
          <Link to="/dashboard/newTask" className="side-bar-item mt-2 d-flex">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
        ...
        <div className="nav-item">
          <Link to="/dashboard/profile" className="side-bar-item mt-2 d-flex">
            <svg
              stroke="currentColor"
              fill="none"
              stroke-width="0"
        ...
        <div className="nav-item">
          <Link to="/dashboard/settings" className="side-bar-item mt-2 d-flex">
            <svg
              stroke="currentColor"
              fill="none"
              stroke-width="2"
